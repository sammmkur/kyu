...
<head>
  ...
  <script src="{{url('https://rawgit.com/schmich/instascan-builds/master/instascan.min.js')}}"></script>
  <style>
   video {
  width: 100%;
  height: auto;
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('scanner.generate')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Generate QrCode</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('scanner.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Scanner</p>
                </a>
              </li>
